...
?>
			...
			?>
							<option value="<?php echo $row->role_id; ?>" <?php echo ($row->role_id==$get->role_id) ? 'selected' : ''; ?>><?php echo $row->role_name; ?></option>
			<?php  
			// End Loop roles
			endforeach;
			?>
				...
				<div class="form-group">
					...
					<div class="col-md-8">
	                    <div class="radio radio-inline radio-info">
	                        <input type="radio" name="active" value="0" <?php echo ($get->active) ? '' : 'checked'; ?>> <label>Tidak</label>
	                    </div>
	                    <div class="radio radio-inline radio-info">
	                        <input type="radio" name="active" value="1" <?php echo ($get->active) ? 'checked' : ''; ?>> <label>Iya</label>
	                    </div>
					</div>
				</div>
			</div>
