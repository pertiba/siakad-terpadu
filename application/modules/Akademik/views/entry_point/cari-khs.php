			...
			<div class="box-body with-border">
				...
				<div class="col-md-3">
					...
					<select name="thn_ajaran" class="form-control">
						...
						<option value="<?php echo $this->option->get('default_thn_ajaran'); ?>" <?php echo ($this->option->get('default_thn_ajaran')==set_value('thn_ajaran')) ? 'selected' : ''; ?>> <?php echo $this->option->get('default_thn_ajaran'); ?></option>
					</select>
					...
					?>
						...
						<tfoot>
							<tr>
								...
								<th colspan="2"><?php echo $bobot; ?></th>
							</tr>
							<tr>
								<th colspan="10"><span class="pull-right">Index Prestasi (IP) :</span></th>
								<th colspan="2"><span style="font-size: 15px;"><?php echo str_replace('.', ',', $this->nilai->getIp()); ?></span></th>
							</tr>
							<tr>
